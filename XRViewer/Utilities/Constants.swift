...
/// The NSUserDefaults key for remove all of the permissions ( allowedMinimalSites, allowedWorldSensingSites, allowedVideoCameraSites )
let ForgetWebXRPermissionsKey = "forgetWebXRPermissions"
...
@objc class Constant: NSObject {
    ...
    static func forgetWebXRPermissionsKey() -> String { return ForgetWebXRPermissionsKey }
...
// URL
let WEB_URL = "https://qa.iq3connect.com:4488"
let LAST_URL_KEY = "lastURL"
let HOMEPAGE_NAME = "homepage.html"
