...
//        imagePlaneVertexBuffer = device?.makeBuffer(bytes: &kImagePlaneVertexData, length: MemoryLayout<kImagePlaneVertexData>.size, options: [])
        ...
        capturedImagePipelineStateDescriptor.rasterSampleCount = renderDestination?.sampleCount ?? 0
        ...
        anchorPipelineStateDescriptor.rasterSampleCount = renderDestination?.sampleCount ?? 0
